...
1. _Explore the General Portal Interface_:
    - Go to the Human Cell Atlas Data Portal website: https://data.humancellatlas.org/

    - Explore the website general functionalities, visualizing the data available and how to contribute with data.